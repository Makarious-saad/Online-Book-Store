...
<?php // Notifications
      if(@$_GET['error'] == 'add'){
        $systemData->swal('Error!','The manger has not been added','error');
      }elseif(@$_GET['error'] == 'update'){
        $systemData->swal('Error!','The manger has not been updated','error');
      }if(@$_GET['success'] == 'add'){
    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4"><strong>View Managers</strong></h3>
                <div class="card shadow">
                    <div class="card-header py-3">
                      <a class="btn btn-info float-right" role="button" href="/admincp/new-manger">Add new manger</a>
                    </div>
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                            ...
                            <?php $result = $systemData->preparedQuery("SELECT * FROM users WHERE account_type=? ORDER BY id DESC",array('admin'));
