    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4"><strong>View Orders</strong></h3>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                          <?php if($shipment == 'pending' && $row['status'] == 'approved'){ ?>
                                            <a class="btn btn-success" role="button" href="../include/check.php?order=charging&id=<?php echo $row['id']; ?>">Charging</a>
                                          <?php }elseif($shipment == 'charging' && $row['status'] == 'approved'){ ?>
